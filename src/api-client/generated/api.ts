...
export const OrganisationenApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        organisationControllerFindOrganizations: async (offset?: number, limit?: number, kennung?: string, name?: string, searchString?: string, typ?: OrganisationsTyp, systemrechte?: Array<RollenSystemRechtEnum>, excludeTyp?: Array<OrganisationsTyp>, administriertVon?: Array<string>, zugehoerigZu?: Array<string>, organisationIds?: Array<string>, sortOrder?: 'asc' | 'desc', sortField?: 'name' | 'kennung', getChildrenRecursively?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (zugehoerigZu) {
                localVarQueryParameter['zugehoerigZu'] = zugehoerigZu;
            }
...
export const PersonenApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        personControllerFindPersonenkontexte: async (personId: string, offset?: number, limit?: number, personId2?: string, username?: string, personenstatus?: Personenstatus, sichtfreigabe?: Sichtfreigabe, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'personId' is not null or undefined
...
export const PersonenApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async personControllerFindPersonenkontexte(personId: string, offset?: number, limit?: number, personId2?: string, username?: string, personenstatus?: Personenstatus, sichtfreigabe?: Sichtfreigabe, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PersonControllerFindPersonenkontexte200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.personControllerFindPersonenkontexte(personId, offset, limit, personId2, username, personenstatus, sichtfreigabe, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const PersonenApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        personControllerFindPersonenkontexte(personId: string, offset?: number, limit?: number, personId2?: string, username?: string, personenstatus?: Personenstatus, sichtfreigabe?: Sichtfreigabe, options?: any): AxiosPromise<PersonControllerFindPersonenkontexte200Response> {
            return localVarFp.personControllerFindPersonenkontexte(personId, offset, limit, personId2, username, personenstatus, sichtfreigabe, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} personId 
...
export interface PersonenApiInterface {
     ...
     * @memberof PersonenApiInterface
     */
    personControllerFindPersonenkontexte(personId: string, offset?: number, limit?: number, personId2?: string, username?: string, personenstatus?: Personenstatus, sichtfreigabe?: Sichtfreigabe, options?: AxiosRequestConfig): AxiosPromise<PersonControllerFindPersonenkontexte200Response>;
...
export class PersonenApi extends BaseAPI implements PersonenApiInterface {
     ...
     * @memberof PersonenApi
     */
    public personControllerFindPersonenkontexte(personId: string, offset?: number, limit?: number, personId2?: string, username?: string, personenstatus?: Personenstatus, sichtfreigabe?: Sichtfreigabe, options?: AxiosRequestConfig) {
        return PersonenApiFp(this.configuration).personControllerFindPersonenkontexte(personId, offset, limit, personId2, username, personenstatus, sichtfreigabe, options).then((request) => request(this.axios, this.basePath));
    }
...
export const PersonenFrontendApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        personFrontendControllerFindPersons: async (offset?: number, limit?: number, username?: string, familienname?: string, vorname?: string, sichtfreigabe?: 'ja' | 'nein', organisationIDs?: Array<string>, rolleIDs?: Array<string>, suchFilter?: string, sortOrder?: ScopeOrder, sortField?: SortFieldPerson, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PersonenFrontendApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async personFrontendControllerFindPersons(offset?: number, limit?: number, username?: string, familienname?: string, vorname?: string, sichtfreigabe?: 'ja' | 'nein', organisationIDs?: Array<string>, rolleIDs?: Array<string>, suchFilter?: string, sortOrder?: ScopeOrder, sortField?: SortFieldPerson, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PersonFrontendControllerFindPersons200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.personFrontendControllerFindPersons(offset, limit, username, familienname, vorname, sichtfreigabe, organisationIDs, rolleIDs, suchFilter, sortOrder, sortField, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const PersonenFrontendApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        personFrontendControllerFindPersons(offset?: number, limit?: number, username?: string, familienname?: string, vorname?: string, sichtfreigabe?: 'ja' | 'nein', organisationIDs?: Array<string>, rolleIDs?: Array<string>, suchFilter?: string, sortOrder?: ScopeOrder, sortField?: SortFieldPerson, options?: any): AxiosPromise<PersonFrontendControllerFindPersons200Response> {
            return localVarFp.personFrontendControllerFindPersons(offset, limit, username, familienname, vorname, sichtfreigabe, organisationIDs, rolleIDs, suchFilter, sortOrder, sortField, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface PersonenFrontendApiInterface {
     ...
     */
    personFrontendControllerFindPersons(offset?: number, limit?: number, username?: string, familienname?: string, vorname?: string, sichtfreigabe?: 'ja' | 'nein', organisationIDs?: Array<string>, rolleIDs?: Array<string>, suchFilter?: string, sortOrder?: ScopeOrder, sortField?: SortFieldPerson, options?: AxiosRequestConfig): AxiosPromise<PersonFrontendControllerFindPersons200Response>;
...
export class PersonenFrontendApi extends BaseAPI implements PersonenFrontendApiInterface {
     ...
     */
    public personFrontendControllerFindPersons(offset?: number, limit?: number, username?: string, familienname?: string, vorname?: string, sichtfreigabe?: 'ja' | 'nein', organisationIDs?: Array<string>, rolleIDs?: Array<string>, suchFilter?: string, sortOrder?: ScopeOrder, sortField?: SortFieldPerson, options?: AxiosRequestConfig) {
        return PersonenFrontendApiFp(this.configuration).personFrontendControllerFindPersons(offset, limit, username, familienname, vorname, sichtfreigabe, organisationIDs, rolleIDs, suchFilter, sortOrder, sortField, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const PersonenInfoApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        personenInfoControllerInfoV1: async (xOffset?: number, xLimit?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ProviderApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        providerControllerFindRollenerweiterungenByServiceProviderId: async (angebotId: string, offset?: number, limit?: number, organisationIds?: Array<string>, rolleIds?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'angebotId' is not null or undefined
...
export const ProviderApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async providerControllerFindRollenerweiterungenByServiceProviderId(angebotId: string, offset?: number, limit?: number, organisationIds?: Array<string>, rolleIds?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProviderControllerFindRollenerweiterungenByServiceProviderId200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.providerControllerFindRollenerweiterungenByServiceProviderId(angebotId, offset, limit, organisationIds, rolleIds, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get all service-providers assignable for a role.
...
export const ProviderApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        providerControllerFindRollenerweiterungenByServiceProviderId(angebotId: string, offset?: number, limit?: number, organisationIds?: Array<string>, rolleIds?: Array<string>, options?: any): AxiosPromise<ProviderControllerFindRollenerweiterungenByServiceProviderId200Response> {
            return localVarFp.providerControllerFindRollenerweiterungenByServiceProviderId(angebotId, offset, limit, organisationIds, rolleIds, options).then((request) => request(axios, basePath));
        },
        /**
         * Get all service-providers assignable for a role.
         * @summary 
...
export interface ProviderApiInterface {
     ...
     * @memberof ProviderApiInterface
     */
    providerControllerFindRollenerweiterungenByServiceProviderId(angebotId: string, offset?: number, limit?: number, organisationIds?: Array<string>, rolleIds?: Array<string>, options?: AxiosRequestConfig): AxiosPromise<ProviderControllerFindRollenerweiterungenByServiceProviderId200Response>;
...
export class ProviderApi extends BaseAPI implements ProviderApiInterface {
     ...
     * @memberof ProviderApi
     */
    public providerControllerFindRollenerweiterungenByServiceProviderId(angebotId: string, offset?: number, limit?: number, organisationIds?: Array<string>, rolleIds?: Array<string>, options?: AxiosRequestConfig) {
        return ProviderApiFp(this.configuration).providerControllerFindRollenerweiterungenByServiceProviderId(angebotId, offset, limit, organisationIds, rolleIds, options).then((request) => request(this.axios, this.basePath));
    }
...
export const RolleApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        rolleControllerApplyRollenerweiterungChangesForRolle: async (rolleId: string, organisationId: string, applyRollenerweiterungChangesBodyParams: ApplyRollenerweiterungChangesBodyParams, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'rolleId' is not null or undefined
            assertParamExists('rolleControllerApplyRollenerweiterungChangesForRolle', 'rolleId', rolleId)
            // verify required parameter 'organisationId' is not null or undefined
            assertParamExists('rolleControllerApplyRollenerweiterungChangesForRolle', 'organisationId', organisationId)
            // verify required parameter 'applyRollenerweiterungChangesBodyParams' is not null or undefined
            assertParamExists('rolleControllerApplyRollenerweiterungChangesForRolle', 'applyRollenerweiterungChangesBodyParams', applyRollenerweiterungChangesBodyParams)
            const localVarPath = `/api/rolle/{rolleId}/organisation/{organisationId}/apply`
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(applyRollenerweiterungChangesBodyParams, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        rolleControllerGetAllSystemrechte: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/rolle/systemrechte`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const RolleApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async rolleControllerApplyRollenerweiterungChangesForRolle(rolleId: string, organisationId: string, applyRollenerweiterungChangesBodyParams: ApplyRollenerweiterungChangesBodyParams, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ServiceProviderResponse>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.rolleControllerApplyRollenerweiterungChangesForRolle(rolleId, organisationId, applyRollenerweiterungChangesBodyParams, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Create a new rolle.
         ...
         * @throws {RequiredError}
         */
        async rolleControllerCreateRolle(createRolleBodyParams: CreateRolleBodyParams, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RolleWithServiceProvidersResponse>> {
        ...
        async rolleControllerFindRollen(offset?: number, limit?: number, searchStr?: string, organisationContextForOperation?: string, organisationenForFilter?: Array<string>, rolleIds?: Array<string>, systemrechte?: Array<RollenSystemRechtEnum>, rollenarten?: Array<RollenArt>, merkmale?: Array<RollenMerkmal>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RolleWithServiceProvidersResponse>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.rolleControllerFindRollen(offset, limit, searchStr, organisationContextForOperation, organisationenForFilter, rolleIds, systemrechte, rollenarten, merkmale, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List rollen available for person administration.
         ...
         * @throws {RequiredError}
         */
        async rolleControllerFindRollenAvailableForPersonAdministration(searchStr?: string, limit?: number, offset?: number, organisationIds?: Array<string>, systemrechte?: Array<RollenSystemRechtEnum>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RolleResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async rolleControllerGetAllSystemrechte(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<SystemRechtResponse>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.rolleControllerGetAllSystemrechte(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get service-providers for a rolle by its id.
...
export const RolleApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        rolleControllerApplyRollenerweiterungChangesForRolle(rolleId: string, organisationId: string, applyRollenerweiterungChangesBodyParams: ApplyRollenerweiterungChangesBodyParams, options?: any): AxiosPromise<Array<ServiceProviderResponse>> {
            return localVarFp.rolleControllerApplyRollenerweiterungChangesForRolle(rolleId, organisationId, applyRollenerweiterungChangesBodyParams, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a new rolle.
         * @summary 
         ...
         * @throws {RequiredError}
         */
        rolleControllerCreateRolle(createRolleBodyParams: CreateRolleBodyParams, options?: any): AxiosPromise<RolleWithServiceProvidersResponse> {
         ...
         * @throws {RequiredError}
         */
        rolleControllerFindRollen(offset?: number, limit?: number, searchStr?: string, organisationContextForOperation?: string, organisationenForFilter?: Array<string>, rolleIds?: Array<string>, systemrechte?: Array<RollenSystemRechtEnum>, rollenarten?: Array<RollenArt>, merkmale?: Array<RollenMerkmal>, options?: any): AxiosPromise<Array<RolleWithServiceProvidersResponse>> {
            return localVarFp.rolleControllerFindRollen(offset, limit, searchStr, organisationContextForOperation, organisationenForFilter, rolleIds, systemrechte, rollenarten, merkmale, options).then((request) => request(axios, basePath));
        },
        /**
         * List rollen available for person administration.
         * @summary 
         ...
         * @throws {RequiredError}
         */
        rolleControllerFindRollenAvailableForPersonAdministration(searchStr?: string, limit?: number, offset?: number, organisationIds?: Array<string>, systemrechte?: Array<RollenSystemRechtEnum>, options?: any): AxiosPromise<Array<RolleResponse>> {
         ...
         * @throws {RequiredError}
         */
        rolleControllerGetAllSystemrechte(options?: any): AxiosPromise<Array<SystemRechtResponse>> {
            return localVarFp.rolleControllerGetAllSystemrechte(options).then((request) => request(axios, basePath));
        },
        /**
         * Get service-providers for a rolle by its id.
         * @summary 
...
export interface RolleApiInterface {
     ...
     */
    rolleControllerApplyRollenerweiterungChangesForRolle(rolleId: string, organisationId: string, applyRollenerweiterungChangesBodyParams: ApplyRollenerweiterungChangesBodyParams, options?: AxiosRequestConfig): AxiosPromise<Array<ServiceProviderResponse>>;
     ...
     * @memberof RolleApiInterface
     */
    rolleControllerFindRollen(offset?: number, limit?: number, searchStr?: string, organisationContextForOperation?: string, organisationenForFilter?: Array<string>, rolleIds?: Array<string>, systemrechte?: Array<RollenSystemRechtEnum>, rollenarten?: Array<RollenArt>, merkmale?: Array<RollenMerkmal>, options?: AxiosRequestConfig): AxiosPromise<Array<RolleWithServiceProvidersResponse>>;
     ...
     * @memberof RolleApiInterface
     */
    rolleControllerFindRollenAvailableForPersonAdministration(searchStr?: string, limit?: number, offset?: number, organisationIds?: Array<string>, systemrechte?: Array<RollenSystemRechtEnum>, options?: AxiosRequestConfig): AxiosPromise<Array<RolleResponse>>;
     ...
     * @memberof RolleApiInterface
     */
    rolleControllerGetAllSystemrechte(options?: AxiosRequestConfig): AxiosPromise<Array<SystemRechtResponse>>;
...
export class RolleApi extends BaseAPI implements RolleApiInterface {
     ...
     * @memberof RolleApi
     */
    public rolleControllerApplyRollenerweiterungChangesForRolle(rolleId: string, organisationId: string, applyRollenerweiterungChangesBodyParams: ApplyRollenerweiterungChangesBodyParams, options?: AxiosRequestConfig) {
        return RolleApiFp(this.configuration).rolleControllerApplyRollenerweiterungChangesForRolle(rolleId, organisationId, applyRollenerweiterungChangesBodyParams, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RolleApi
     */
    public rolleControllerFindRollen(offset?: number, limit?: number, searchStr?: string, organisationContextForOperation?: string, organisationenForFilter?: Array<string>, rolleIds?: Array<string>, systemrechte?: Array<RollenSystemRechtEnum>, rollenarten?: Array<RollenArt>, merkmale?: Array<RollenMerkmal>, options?: AxiosRequestConfig) {
        return RolleApiFp(this.configuration).rolleControllerFindRollen(offset, limit, searchStr, organisationContextForOperation, organisationenForFilter, rolleIds, systemrechte, rollenarten, merkmale, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RolleApi
     */
    public rolleControllerGetAllSystemrechte(options?: AxiosRequestConfig) {
        return RolleApiFp(this.configuration).rolleControllerGetAllSystemrechte(options).then((request) => request(this.axios, this.basePath));
    }

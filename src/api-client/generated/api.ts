...
export const OrganisationenApiFactory = function (
  ...
  return {
    ...
    organisationControllerGetAdministrierteOrganisationen(
      ...
      return localVarFp
        .organisationControllerGetAdministrierteOrganisationen(organisationId, searchFilter, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export const PersonenApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    personControllerLockPerson: async (
      personId: string,
...
export const PersonenApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async personControllerLockPerson(
      personId: string,
      lockUserBodyParams: LockUserBodyParams,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PersonLockResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.personControllerLockPerson(
        personId,
        lockUserBodyParams,
        options,
      );
...
export const PersonenApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    personControllerLockPerson(
      ...
      lockUserBodyParams: LockUserBodyParams,
      options?: any,
    ): AxiosPromise<PersonLockResponse> {
      return localVarFp
        .personControllerLockPerson(personId, lockUserBodyParams, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
